                     ...
                     <table class="table custom_table">
                        <thead class="thead-dark">
                           <tr>
                              ...
                              <th scope="col" class="table_5"><button onclick="showaddCallModal('support');"><i class="fa fa-phone font_phone" aria-hidden="true"></i></button></th>
                           </tr>
                        </thead>
                     ...
                     <table class="table custom_table">
                        <thead class="thead-dark">
                           <tr>
                              ...
                              <th scope="col" class="table_5">No of calls</th>
                              <th scope="col" class="table_10">Remark</th>
                              <th scope="col" class="table_5"><button onclick="showaddCallModal('mp');"><i class="fa fa-phone font_phone" aria-hidden="true"></i></button></th>
                           </tr>
                        </thead>
